...
with open('feed.yaml', 'r' ) as file: #opens yaml document and reads it
    yaml_data = yaml.safe_load(file) #safe load is a function that verifies that the file will load safely 
...
for item in yaml_data ['item']:
    ...
    xml_tree.SubElement(item_element, 'itunes:author').text = item.get('author', '')    
